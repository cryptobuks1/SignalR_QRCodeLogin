...
namespace SignalR_QRCodeLogin.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public ActionResult Login(string returnUrl)
        {
            ...
            ViewBag.QRCode = Url.Action("QRCodeLogin", "Account", null, "http");
        ...
        {
            string ConnectionId = Request.QueryString["ConnectionId"];
            ...
            _hubContext.Clients.Client(ConnectionId).loginSuccess(Url.Action("NotifyLogin", "Account", new { Email = Email }));

            return RedirectToAction("Index", "Home");
        }

        [AllowAnonymous]
        public ActionResult NotifyLogin(string id)
        {
            string Email = Request.QueryString["Email"];

            ApplicationUser user = UserManager.FindByEmail(Email);
            SignInManager.SignIn(user: user, isPersistent: true, rememberBrowser: true);
